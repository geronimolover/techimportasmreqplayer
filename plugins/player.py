...
async def not_chat(_, m: Message):
    ...
    k=await m.reply_photo(photo="https://telegra.ph/file/2cc60cb6ad087b6f14ed7.png", caption="**Sorry, You Can't Use This Bot In This Group!😉/n Contact @brandfreehelper to make a bot for your group**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
